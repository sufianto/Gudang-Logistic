...
-->
                    ...
                    <ul id="sidebarnav" class="p-t-30">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark"
                                href="javascript:void(0)" aria-expanded="false"><i
                                    class="mdi mdi-application"></i><span class="hide-menu">barang </span></a>
                            <ul aria-expanded="false" class="collapse first-level">
                                <li class="sidebar-item"><a href="{{ route('barang-masuk.daftar') }}"
                                        class="sidebar-link"><i class="mdi mdi-chevron-right"></i><span
                                            class="hide-menu"> Barang Masuk </span></a></li>
                                <li class="sidebar-item"><a href="{{ route('barang-keluar.daftar') }}"
                                        class="sidebar-link"><i class="mdi mdi-chevron-right"></i><span
                                            class="hide-menu"> Barang Keluar </span></a></li>
                                <li class="sidebar-item"><a href="{{ route('stok-barang.daftar') }}"
                                        class="sidebar-link"><i class="mdi mdi-chevron-right"></i><span
                                            class="hide-menu"> Stok Barang</span></a></li>
                            </ul>
                        </li>
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark"
                            ...
                            <ul aria-expanded="false" class="collapse first-level">
                                ...
                                <li class="sidebar-item"><a href="{{ route('barang-masuk.laporan') }}"
                                        class="sidebar-link"><i class="mdi mdi-chevron-right"></i><span
                                            class="hide-menu">Laporan Barang Masuk </span></a></li>
                                <li class="sidebar-item"><a href="{{ route('barang-keluar.laporan') }}"
                                        class="sidebar-link"><i class="mdi mdi-chevron-right"></i><span
                                            class="hide-menu">Laporan Barang Keluar </span></a></li>
                                <li class="sidebar-item"><a href="{{ route('stok-barang.laporan') }}"
                                        class="sidebar-link"><i class="mdi mdi-chevron-right"></i><span
                                            class="hide-menu">Laporan Stok Barang</span></a></li>
                            </ul>
                        </li>
        ...
        <div class="page-wrapper">
            ...
            <footer class="footer text-center">
                Web Programming. Studi Kasus Gudang
                Logistic.
            </footer>
            <!-- ============================================================== -->
            <!-- End footer -->
